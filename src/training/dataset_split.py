...
# ── Config ────────────────────────────────────────────────────────────────────
IMAGES_DIR  = Path('/home/nicola/ros2_ws/data/yolo_RW_dataset/images')    # your existing flat images folder
LABELS_DIR  = Path('/home/nicola/ros2_ws/data/yolo_RW_dataset/labels')    # your existing flat labels folder
OUTPUT_DIR  = Path('/home/nicola/ros2_ws/data/yolo_RW_dataset')
VAL_SPLIT   = 0.15
SEED        = 42
# ─────────────────────────────────────────────────────────────────────────────
