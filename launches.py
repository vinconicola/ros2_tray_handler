...
def generate_gazebo_launch(moveit_config, launch_package_path=None):
    ...
    ld.add_action(SetEnvironmentVariable(
        ...
        "/home/nicola/ros2_ws/install/jaka_description/share"))
    ld.add_action(SetEnvironmentVariable(
        "GZ_SIM_SYSTEM_PLUGIN_PATH",
        "/home/nicola/ros2_ws/install/gz_ros2_control/lib:"
    ...
    # Start YOLO inference node
    ld.add_action(
        TimerAction(
            period=8.0,  # Wait for Gazebo and controllers to be ready
            actions=[
                Node(
